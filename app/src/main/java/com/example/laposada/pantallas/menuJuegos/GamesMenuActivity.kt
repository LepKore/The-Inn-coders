...
import com.example.laposada.pantallas.menuJuegos.EditGameOptionsActivity
import com.example.laposada.pantallas.menuJuegos.GameDescriptionActivity
...
class GamesMenuActivity : AppCompatActivity() {
    ...
    private fun setupListeners() {
        ...
        binding.buttonEdit.setOnClickListener {
             val intent = Intent(context, EditGameOptionsActivity::class.java)
             launcherEditMenu.launch(intent)
        }
    }
